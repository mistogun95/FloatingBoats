<?php
    ...
    $name = "zio";
    $surname = "zio";*/
    $username = "kaio";//presumendo di aver già fatto il login e di aver settato bene le session
...
//                $var_directory.$username.".".$var_tipo_immagine
    ...
    echo "<a class='signIn' href='Registration.html'>Clicca qui per tornare alla pagina di registrazione</a>";
?>
